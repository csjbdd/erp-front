        ...
        <div class="col-12 lg:col-6 xl:col-3">
            <div class="card mb-0">
                <div class="flex justify-content-between mb-3">
                    <div>
                        <span class="block text-500 font-medium mb-3">미결재 서류</span>
                ...
                <span class="text-green-500 font-medium">결재</span>
                <span class="text-500"> 바로가기</span>
            </div>
        </div>
        <div class="col-12 lg:col-6 xl:col-3">
            <div class="card mb-0">
                <div class="flex justify-content-between mb-3">
                    <div>
                        <span class="block text-500 font-medium mb-3">오늘의 일정</span>
                ...
                <span class="text-green-500 font-medium">캘린더 </span>
                <span class="text-500">바로가기</span>
            </div>
